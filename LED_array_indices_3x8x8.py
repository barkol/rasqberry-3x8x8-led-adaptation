...
Each panel uses progressive (non-serpentine) row wiring:
  ...
  - Assembly mounted upside-down (rotated 180°): pixel 0 at top-right
  - Both X and Y are flipped to compensate for 180° rotation
...
for _i in range(192):
    ...
    _panel = 2 - _x // 8         # reverse panel order (180° rotation)
    _col = 7 - _x % 8            # reverse column within panel
