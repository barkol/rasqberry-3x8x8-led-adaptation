...
def map_xy_to_pixel_triple_8x8(x, y):
    """
...
def map_xy_to_pixel(x, y, layout=None):
    ...
    Args:
        ...
        y (int): Row index (0-7)
        layout (str, optional): 'single', 'quad', or 'triple_8x8'. If None, reads from config.
    ...
    Example:
        ...
        # Override layout
        pixel_index = map_xy_to_pixel(5, 3, layout='triple_8x8')
    """
    ...
    elif layout == 'triple_8x8':
        return map_xy_to_pixel_triple_8x8(x, y)
    else:
